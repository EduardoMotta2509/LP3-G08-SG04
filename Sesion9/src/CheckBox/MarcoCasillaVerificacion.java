...
public class MarcoCasillaVerificacion extends JFrame {
    ...
    private JCheckBox magicoJCheckBox;

    public MarcoCasillaVerificacion() {
        super("CheckBox de Eduardo y Leandro");
        setLayout(new FlowLayout());

        campoTexto = new JTextField("Es un texto misterioso", 20);
        campoTexto.setFont(new Font("Serif", Font.PLAIN, 14));
        add(campoTexto);

        negritaJCheckBox = new JCheckBox("Negrita");
        cursivaJCheckBox = new JCheckBox("Cursiva");
        magicoJCheckBox= new JCheckBox("Mágico");
        ...
        magicoJCheckBox.addItemListener(manejador);
    }
    ...
    private class ManejadorCheckBox implements ItemListener {
        ...
        public void itemStateChanged(ItemEvent evento) {
            ...
            if(magicoJCheckBox.isSelected())
            	tipoletra= new Font("Arial", Font.BOLD + Font.ITALIC, 20);
            else if (negritaJCheckBox.isSelected() && cursivaJCheckBox.isSelected())
