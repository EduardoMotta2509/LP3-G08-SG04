...
public class MarcoGridLayout extends JFrame implements ActionListener {
    ...
    public MarcoGridLayout() {
        super("GridLayout de Eduardo y Leandro");
    ...
    public void actionPerformed(ActionEvent evento) {
        String textoBoton = ((JButton) evento.getSource()).getText();
        if (textoBoton.equals("dos") || textoBoton.equals("cuatro") || textoBoton.equals("seis")) {
