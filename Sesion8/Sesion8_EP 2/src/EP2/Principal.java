...
//            Gestor.verTodosLosRegistros();
    ...
    private static void mostrarMenu(Connection conn) throws SQLException {
        ...
        do {
            ...
            System.out.println("6. Consultar alumnos en ARRAY (desde memoria)");
            ...
            switch (opcion) {
                ...
                case 6 -> {
                    ...
                    gestor.mostrarMenu(); // Menú propio del gestor
                }
...
//                
//                String searchPrompt = "SELECT * FROM alumno WHERE codigo = ?";
//                PreparedStatement pst = conn.prepareStatement(searchPrompt);
//                pst.setString(1, codigo);
//          
//                ResultSet rs = pst.executeQuery();
//                Gestor.guardarRegistro(conn, rs);
            } else {
                conn.rollback();
